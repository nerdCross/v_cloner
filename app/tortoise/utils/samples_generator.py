...
if __name__ == "__main__":
    ...
    for fv in os.listdir("../../results/favorites"):
        ...
        result = (
            result
            + f'<audio controls="" style="width: 600px;"><source src="{url}" type="audio/mp3"></audio><br>\n'
        )
    ...
    result = (
        result
        + "<h1>Compared to Tacotron2 (with the LJSpeech voice):</h1><table><th>Tacotron2+Waveglow</th><th>TorToiSe</th>"
    )
    for k in range(2, 5, 1):
        ...
        result = (
            result
            + f'<tr><td><audio controls="" style="width: 300px;"><source src="{url1}" type="audio/mp3"></audio><br>\n</td>'
    ...
    for v in voices:
        ...
        line = (
            line
            + f'<td><audio controls="" style="width: 150px;"><source src="{url}" type="audio/mp3"></audio></td>'
        )
    line = line + "</tr>"
    lines.append(line)
    ...
    for lf in os.listdir("../../results/riding_hood"):
        url = (
            f"https://github.com/neonbjb/tortoise-tts/raw/main/results/riding_hood/{lf}"
        )
        result = (
            result
            + f'<audio controls="" style="width: 600px;"><source src="{url}" type="audio/mp3"></audio><br>\n'
